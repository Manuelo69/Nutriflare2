...
class ObjetivoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'grasa_objetivo.required' => 'El campo grasa corporal es obligatorio.',
            'grasa_objetivo.numeric' => 'El campo grasa corporal debe ser un valor numérico.',
            'min_cardio_objetivo.required' => 'El campo minutos cardio es obligatorio.',
            'min_cardio_objetivo.numeric' => 'El campo minutos cardio debe ser un valor numérico.',
